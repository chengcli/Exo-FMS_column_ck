...
contains
  ...
  subroutine Parmentier_IC(nlay,pl,Tint,mu_in,Tirr_in,grav,Tl,table_num,met)
    implicit none

    integer, intent(in) :: nlay
    real(dp), dimension(nlay), intent(in) :: pl
    real(dp), intent(in) :: Tint, mu_in, Tirr_in, grav
    ...
    real(dp) :: Teff0, Teff, Tmu, Bond, Tskin, mu, Tirr
